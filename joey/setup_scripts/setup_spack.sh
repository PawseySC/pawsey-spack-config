...
cp -p pawsey-spack-config/joey/configs/site_allusers/*.yaml spack/etc/spack/
cp -p pawsey-spack-config/joey/configs/spackuser_pawseystaff/*.yaml ~/.spack/
...
#cp -p pawsey-spack-config/joey/fixes/microarchitectures.json spack/lib/spack/external/archspec/json/cpu/
# Marco,s Lmod arch family fix for the module tree
patch spack/lib/spack/spack/modules/lmod.py pawsey-spack-config/joey/fixes/lmod_arch_family.patch
# Pascal,s enhancements to modulefiles
patch spack/lib/spack/spack/modules/common.py pawsey-spack-config/joey/fixes/modulenames_plus_common.patch
patch spack/lib/spack/spack/cmd/modules/__init__.py pawsey-spack-config/joey/fixes/modulenames_plus_init.patch
...
sed \
  ...
  pawsey-spack-config/joey/setup/module_spack.lua \
