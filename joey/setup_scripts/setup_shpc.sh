...
shpc config add registry:${root_dir}/pawsey-spack-config/joey/shpc_registry
# user install location for modulefiles
shpc config set module_base:/software/\$PAWSEY_PROJECT/\$USER/joey/containers/modules
# disable default version for modulefiles
shpc config set default_version:false
# user install location for containers
shpc config set container_base:/software/\$PAWSEY_PROJECT/\$USER/joey/containers/sif
# singularity module
...
sed \
 ...
 pawsey-spack-config/joey/setup/module_${shpc_name}.lua \
