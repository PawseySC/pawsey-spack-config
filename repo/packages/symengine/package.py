...
#
# Pawsey: added symengine 0.11.1, 0.12.0 and 0.13.0 to provide the C++ library
# versions required by the newer py-symengine releases pulled in by py-qiskit
# (py-symengine@0.11:0.13).
...
class Symengine(CMakePackage):
    ...
    version("0.13.0", sha256="f46bcf037529cd1a422369327bf360ad4c7d2b02d0f607a62a5b09c74a55bb59")
    version("0.12.0", sha256="1b5c3b0bc6a9f187635f93585649f24a18e9c7f2167cebcd885edeaaf211d956")
    version("0.11.1", sha256="217b39955dc19f920c6f54c057fdc89e8e155ddee8f0e3c3cacc67b3e3850b64")
