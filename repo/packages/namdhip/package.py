...
class Namdhip(MakefilePackage, ROCmPackage):
    ...
    #url = "file://{0}/NAMD_2.15a2_Source-AMDHIP.tar.gz".format(os.getcwd())
    url = "file://{0}/namdhip-2.15a2.tar.gz".format(os.getcwd())
    ...
    #    "2.15a1.manual", sha256="474006e98e32dddae59616b3b75f13a2bb149deaf7a0d617ce7fb9fd5a56a33a"
        "2.15a1.manual", sha256="e985c13b22a3404825fe0a088ed1f2b566d157629f8ffdb4f40053eb5c35103e"
    )
    version(
        "2.14",
    ...
    depends_on("charmpp@7.0.0:", when="@2.14:")
