...
# Pawsey: install_tree wa failing with copying file. It is replaced with shutil.copy2
import shutil
import os
import os.path
import re
...
#            install_tree("bin", join_path(self.prefix, "libexec", "llvm"))
        ...
        with working_dir(self.build_directory):
            dest_dir = join_path(self.prefix, "libexec", "llvm")
            mkdirp(dest_dir)
            ...
            for f in os.listdir("bin"):
                ...
                try:
                    ...
                    tty.warn(f"Skipping file '{f}' during install due to error: {e}")
