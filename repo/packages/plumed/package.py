...
# Pawsey, Ilkhom: patch("fix_json_Makefile.patch", when="@2.9.2:%cce")
# this patch is get rid of '[CRAYBLAS_WARNING] Application linked against multiple cray-libsci libraries' 
# from the syntax.json file
