...
# Pawsey, Ilkhom: added version("3.0.1", sha256="3be0854545c45e58afb439a96708e127aef435d30113cc89adbab8f4b6888733")
# Vesrion 3.0.1 is reccomended by namd's website
...
class Namd(MakefilePackage, CudaPackage, ROCmPackage):
    ...
    version("3.0.2", sha256="419ddb3c66fe27308c87807e1a00bb10437111e6f0832d6b214cff512c2ad969")
    ...
    patch(
        "namd-2.14-psfgen-handler-signatures.patch",
        when="@2.14 %gcc@14:",
    )
