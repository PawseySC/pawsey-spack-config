...
class Hpcviewer(Package):
    ...
    viewer_sha = {
        ("2025.2.0", "aarch64"): "565bba471273f897c3436dd8b152720e7862a44588204171b8778a2f5b463dfc",
        ("2025.2.0", "ppc64le"): "eabfa180fc023b9d0d3db06763ec5bb9abc278d65a9763cd26d214605d1b8ddf", # this checksum needs updating
        ...
        for (ver, arch), sha in viewer_sha.items():
            if arch == machine:
                if ver > "2024.09":
                    version(
                    ver,
                    url=f"https://gitlab.com/hpctoolkit/hpcviewer/-/releases/{ver}/downloads/hpcviewer-linux.gtk.{arch}.tar.gz",
                    sha256=sha,
                    )
                else:
                    version(
