...
class AnsysFluids(Package):
    ...
    version('2025R2',sha256='d8fb101585b0a8ce4f22feccba2fd7d6eea805de6b6be5b04b16c1f66835665c')
    ansysversion = {
            "2022R1": "v221",
            "2023R1": "v231",
            "2025R2": "v252"
    ...
    def install(self, spec, prefix):
        ...
        if spec.satisfies('@2025R2'):
            self.preferred_version = self.ansysversion["2025R2"]
            self.versionfloat = "25.2.0"
...
#       run_install = Executable("./INSTALL -silent -install_dir {0}/{1} -usetempdir {2}/{3}".format(tmp_install_path, 'fluids', self.stage.source_path, 'fluids_tmpdir'))
        ...
        if spec.satisfies('@2025R2'):
             config_options.append("-nochecks")
...
#                "-install_dir {0}/{1}".format(tmp_install_path, 'fluids', self.stage.source_path, 'fluids_tmpdir'),
        ...
        if spec.satisfies('@2022R1') or spec.satisfies('@2023R1'):
        ...
        if spec.satisfies('@202252'):
            sed("s/platform=None/platform=linx64/g", "{0}/{1}/{2}/commonfiles/CPython/3_10/linx64/Release/Ansys/Util/Platform.py".format(tmp_install_path, 'fluids',self.preferred_version))
    ...
    def setup_run_environment(self,env):
        ...
        if self.spec.satisfies('@2022R1') or self.spec.satisfies('@2023R1'):
            ldpathlist=[
                "/fluent/lib/lnamd64/",
        ...
        if self.spec.satisfies('@2025R2'):
            ldpathlist=[
                ...
                "/fluent/fluent{0}/multiport/lnamd64/mpi/shared/".format(self.versionfloat),
                "/fluent/fluent{0}/multiport/mpi_wrapper/lnamd64/intel/".format(self.versionfloat),
                "/tp/IntelMKL/2023.1.0/linx64/lib/intel64/",
                "/tp/IntelCompiler/2023.1.0/linx64/lib/intel64/",
                "/tp/qt/5.15.18/linx64/lib/",
                "/fluent/fluent{0}/utility/viewfac/multiport/mpi/lnamd64/".format(self.versionfloat),
                "/opt/cray/pe/mpich/8.1.27/ofi/GNU/9.1/lib-abi-mpich/"
                ]
