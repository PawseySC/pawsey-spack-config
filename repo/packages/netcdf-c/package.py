...
# Pawsey, Ilkhom: added 
#        if self.pkg.spec.compiler.name == "cce":
#          # Add -lgcc to the linker flags
#          base_cmake_args.append(self.define("CMAKE_EXE_LINKER_FLAGS", "-lgcc"))
#          base_cmake_args.append(self.define("CMAKE_SHARED_LINKER_FLAGS", "-lgcc"))
#
#        if name == "cflags":
