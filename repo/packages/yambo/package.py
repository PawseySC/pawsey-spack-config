...
#>     @when("@5.2")
#134,135c127,128
#<             "iotk_archive/archive/iotk-y1.2.2.tar.gz",
...
#170d163
#<         args.append(f"--with-fft-libs={spec['fftw'].libs}")
#172,176c165,167
#<         # args.append(f"--with-netcdf-path={spec['netcdf-c'].prefix}")
#<         args.append(f"--with-netcdf-libs={spec['netcdf-c'].libs}")
#<         # args.append(f"--with-netcdff-path={spec['netcdf-fortran'].prefix}")
#<         args.append(f"--with-netcdff-libs={spec['netcdf-fortran'].libs}")
