...
class Opencv(CMakePackage, CudaPackage):
    ...
    # Pawsey: backported from upstream Spack develop for CUDA 13 support
    ...
    def cmake_args(self):
        ...
        if "+cuda" in spec:
            ...
            # Pawsey: backported from upstream Spack develop.
            # https://github.com/opencv/opencv/pull/23021 - required for CUDA 13.
