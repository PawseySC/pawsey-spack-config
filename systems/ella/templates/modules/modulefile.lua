...
local singularity_bindpath = "/pawsey/ella/"
...
{% endif %}
{% if spec.name == 'r' %}setenv("R_LIBS_USER", os.getenv("MYSOFTWARE").."/ella/DATE_TAG/r/%v")
{% endif %}
{% if spec.name == 'python' %}setenv("PYTHONUSERBASE", os.getenv("MYSOFTWARE").."/ella/DATE_TAG/python")
