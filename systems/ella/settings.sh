...
if [ -z ${INSTALL_PREFIX+x} ]; then
    INSTALL_PREFIX="/pawsey/ella/${DATE_TAG}"
fi
...
singularity_version="4.1.3.-nompi" # has to match the version in the Spack env yaml + nompi tag
singularity_mpi_version="4.1.3-mpi" # has to match the version in the Spack env yaml + mpi tag
shpc_version="0.1.23"
