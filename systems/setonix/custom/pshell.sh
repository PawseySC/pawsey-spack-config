...
STACK_VERSION=2026.09
DATE_TAG=${STACK_VERSION}
INSTALL_PREFIX=/scratch/pawsey0001/ilkhom/${DATE_TAG}
COMPILER=gcc
...
for ARCH in "${ARCH_LIST[@]}"; do
    ...
    INSTALL_DIR_PREFIX="${INSTALL_PREFIX}/software/${OSARCH}/${COMPILER}-${COMPILER_VERSION}/${PROGRAM_NAME}-${PROGRAM_VERSION}"
    MODULEFILE_DIR="${INSTALL_PREFIX}/modules/${ARCH}/${COMPILER}/${COMPILER_VERSION}/utilities/${PROGRAM_NAME}"
...
rm -rf pshell-${PROGRAM_VERSION} "v${PROGRAM_VERSION}.tar.gz"
