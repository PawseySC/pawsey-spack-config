...
if [ -z ${INSTALL_PREFIX+x} ]; then
    INSTALL_PREFIX="/software/joey/${DATE_TAG}"
fi
...
SPACK_USER_CONFIG_PATH="$MYSOFTWARE/joey/.spack_user_config"
BOOTSTRAP_PATH='$MYSOFTWARE/joey/.spack_user_config/bootstrap'
