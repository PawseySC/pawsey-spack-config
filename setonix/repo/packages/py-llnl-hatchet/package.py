...
class PyLlnlHatchet(PythonPackage):
    ...
    version('2022.1.0', sha256='f5db1bc2f0bb62dddc302afc47fcac6d5ca5ce6611f18169517becc6023d0d9a')
    ...
    depends_on('python@2.7:', when='@2022.1.0:', type=('build', 'run'))
